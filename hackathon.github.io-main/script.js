...
document.getElementById("tab1").style.backgroundColor = "var(--primary-red)";
...
function changeTab(tabNumber) {
    ...
    tabs.forEach((tab) => {
        tab.style.backgroundColor = "var(--secondary-blue)";
    });
    document.querySelector(`#tab${tabNumber}`).style.backgroundColor = "var(--primary-red)";
    if (tabNumber === 1) {
